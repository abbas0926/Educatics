    ...
    <div class="card-body">
        <form method="POST" action="{{ route("tenant.invoices.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tva') ? 'is-invalid' : '' }}" type="number" name="tva" id="tva" value="{{ old('tva', '19') }}" step="0.01" max="100">
                @if($errors->has('tva'))
                    <div class="invalid-feedback">
                        {{ $errors->first('tva') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_to_pay') ? 'is-invalid' : '' }}" type="number" name="total_to_pay" id="total_to_pay" value="{{ old('total_to_pay', '') }}" step="0.01">
