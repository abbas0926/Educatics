...
@can('teacher_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('tenant.teachers.create') }}">
...
@can('teacher_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('tenant.teachers.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('tenant.teachers.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Teacher').DataTable(dtOverrideGlobals);
