...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("tenant.teachers.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="first_name">{{ trans('cruds.teacher.fields.first_name') }}</label>
            ...
            <div class="form-group">
                <label for="last_name">{{ trans('cruds.teacher.fields.last_name') }}</label>
            ...
            <div class="form-group">
                <label for="phone">{{ trans('cruds.teacher.fields.phone') }}</label>
            ...
            <div class="form-group">
                <label for="photo">{{ trans('cruds.teacher.fields.photo') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.teacher.fields.photo_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="cv">{{ trans('cruds.teacher.fields.cv') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.teacher.fields.cv_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="speciality">{{ trans('cruds.teacher.fields.speciality') }}</label>
                <input class="form-control {{ $errors->has('speciality') ? 'is-invalid' : '' }}" type="text" name="speciality" id="speciality" value="{{ old('speciality', '') }}">
                @if($errors->has('speciality'))
                    <div class="invalid-feedback">
                        {{ $errors->first('speciality') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.teacher.fields.speciality_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    url: '{{ route('tenant.teachers.storeMedia') }}',
    maxFilesize: 5, // MB
...
<script>
    ...
    init: function () {
@if(isset($teacher) && $teacher->cv)
      var file = {!! json_encode($teacher->cv) !!}
          this.options.addedfile.call(this, file)
      file.previewElement.classList.add('dz-complete')
