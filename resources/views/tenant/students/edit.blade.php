...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("tenant.students.update", [$student->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $student->first_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('birthdate') ? 'is-invalid' : '' }}" type="text" name="birthdate" id="birthdate" value="{{ old('birthdate', $student->birthdate) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('adresse') ? 'is-invalid' : '' }}" type="text" name="adresse" id="adresse" value="{{ old('adresse', $student->adresse) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('study_level') ? 'is-invalid' : '' }}" type="text" name="study_level" id="study_level" value="{{ old('study_level', $student->study_level) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('establishement') ? 'is-invalid' : '' }}" type="text" name="establishement" id="establishement" value="{{ old('establishement', $student->establishement) }}">
