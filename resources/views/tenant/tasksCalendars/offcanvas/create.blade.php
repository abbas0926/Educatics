...
<div class="offcanvas offcanvas-end" tabindex="-1" id="createTaskCanva" aria-labelledby="createTaskCanvaLabel">
  <div class="offcanvas-header">
    <h5 id="createTaskCanvaLabel">{{__('Create new task')}}</h5>
    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
  </div>
  <div class="offcanvas-body">
    <form method="POST" action="{{ route("tenant.tasks.storeFromCalendar") }}" enctype="multipart/form-data">
        @csrf
