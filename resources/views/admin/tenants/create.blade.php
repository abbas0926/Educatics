    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tenants.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('valid_until') ? 'is-invalid' : '' }}" type="text" name="valid_until" id="valid_until" value="{{ old('valid_until') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('store_location') ? 'is-invalid' : '' }}" name="store_location" id="store_location">{{ old('store_location') }}</textarea>
