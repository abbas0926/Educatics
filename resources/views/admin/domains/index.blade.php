...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Domain">
            <thead>
                <tr>
                    <th width="10">
...
{ data: 'domain_type', name: 'domain_type' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Domain').DataTable(dtOverrideGlobals);
