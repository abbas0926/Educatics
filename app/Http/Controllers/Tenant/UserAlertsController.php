...
use App\Http\Requests\Tenant\MassDestroyUserAlertRequest;
use App\Http\Requests\Tenant\StoreUserAlertRequest;
use App\Models\User;
...
class UserAlertsController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('tenant.userAlerts.index');
    }
    ...
    public function create()
    {
        ...
        return view('tenant.userAlerts.create', compact('users'));
    }
    ...
    public function show(UserAlert $userAlert)
    {
        ...
        return view('tenant.userAlerts.show', compact('userAlert'));
    }
