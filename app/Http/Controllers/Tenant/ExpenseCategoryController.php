...
use App\Http\Requests\Tenant\MassDestroyExpenseCategoryRequest;
use App\Http\Requests\Tenant\StoreExpenseCategoryRequest;
use App\Http\Requests\Tenant\UpdateExpenseCategoryRequest;
...
class ExpenseCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('tenant.expenseCategories.index', compact('expenseCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.expenseCategories.create');
    }
    ...
    public function edit(ExpenseCategory $expenseCategory)
    {
        ...
        return view('tenant.expenseCategories.edit', compact('expenseCategory'));
    }
    ...
    public function show(ExpenseCategory $expenseCategory)
    {
        ...
        return view('tenant.expenseCategories.show', compact('expenseCategory'));
    }
