...
use App\Http\Requests\Tenant\MassDestroyIncomeCategoryRequest;
use App\Http\Requests\Tenant\StoreIncomeCategoryRequest;
use App\Http\Requests\Tenant\UpdateIncomeCategoryRequest;
...
class IncomeCategoryController extends Controller
{
    public function index()
    {
        ...
        return view('tenant.incomeCategories.index', compact('incomeCategories'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.incomeCategories.create');
    }
    ...
    public function store(StoreIncomeCategoryRequest $request)
    {
        ...
        return redirect()->route('tenant.income-categories.index');
    }
    ...
    public function edit(IncomeCategory $incomeCategory)
    {
        ...
        return view('tenant.incomeCategories.edit', compact('incomeCategory'));
    }
    ...
    public function show(IncomeCategory $incomeCategory)
    {
        ...
        return view('tenant.incomeCategories.show', compact('incomeCategory'));
    }
