...
use App\Http\Requests\Tenant\MassDestroyTaskTagRequest;
use App\Http\Requests\Tenant\StoreTaskTagRequest;
use App\Http\Requests\Tenant\UpdateTaskTagRequest;
...
class TaskTagController extends Controller
{
    public function index()
    {
        ...
        return view('tenant.taskTags.index', compact('taskTags'));
    }
    ...
    public function create()
    {
        ...
        return view('tenant.taskTags.create');
    }
    ...
    public function edit(TaskTag $taskTag)
    {
        ...
        return view('tenant.taskTags.edit', compact('taskTag'));
    }
    ...
    public function show(TaskTag $taskTag)
    {
        ...
        return view('tenant.taskTags.show', compact('taskTag'));
    }
