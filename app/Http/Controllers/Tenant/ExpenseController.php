...
use App\Http\Requests\Tenant\MassDestroyExpenseRequest;
...
class ExpenseController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('tenant.expenses.create', compact('expense_categories'));
    }
    ...
    public function edit(Expense $expense)
    {
        ...
        return view('tenant.expenses.edit', compact('expense', 'expense_categories'));
    }
    ...
    public function show(Expense $expense)
    {
        ...
        $expense->load('expense_category', 'expensesMarketingCampaigns');
